    ...
    <body>
		...
		<footer class="container">
			<div class="row text-right">
				<input type="button" disabled="disabled" id="deleteDataTable" value="Очистить данные" class="btn btn-danger">
			</div>
		</footer>
...
<script type="text/javascript">
    (function (d, w, c) {
        (w[c] = w[c] || []).push(function() {
            try {
                w.yaCounter35867395 = new Ya.Metrika({
                    id:35867395,
                    clickmap:true,
                    trackLinks:true,
...
<noscript><div><img src="https://mc.yandex.ru/watch/35867395" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
    </body>
</html>